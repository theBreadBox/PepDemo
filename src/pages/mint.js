...
import Closed from "../images/CLOSED_CAN.png" 
import Open from "../images/OPEN_CAN.png"
...
function Mint() {
	...
	//Links
	const [openseaURL, setOpenseaURL] = useState('https://testnets.opensea.io/collection/pepdemo')
	const [websiteURL, setWebsiteURL] = useState('https://www.BakedBlueJays.io')
	const [contractOpenseaURL, setContractOpenseaURL] = useState('https://testnets.opensea.io/collection/pepdemo')
	...
	const [blockchainExplorerURL, setBlockchainExplorerURL] = useState('https://rinkeby.etherscan.io/address/0x6c85606415eb29813d3b02564915640f0e80f042')
	//Misc
...
//console.log(accounts)
	...
	const renderHandleTitle = () => {
		...
		if (presaleOnly) {
			...
			return <Title>Minting Now! <br/>.05eth          
			  </Title>
		}
	}
